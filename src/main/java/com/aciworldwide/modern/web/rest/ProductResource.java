...
import com.aciworldwide.modern.repository.ProductRepository;
...
public class ProductResource {
    ...
    /**
     * GET /products -> get all the products with low stock.
     */
    @RequestMapping(value = "/products/reorder/{reorder}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<Product> getLowStockProducts(
            @PathVariable int reorder) {
        log.debug(
                "REST request to get all Products with low stock");
        return productRepository
                .findByStockIsLessThanEqual(reorder);
    }
